(() => {
  ...
  function setSousGenres(names) {
    ...
    const SIMPLE_MAP = {
      ...
      'war and politics': 'Guerre & Politique',
      'guerre & politique': 'Guerre & Politique',
      'guerre et politique': 'Guerre & Politique',
      'history': 'Historique',
  ...
  const NAME_TO_LOCAL = {
    ...
    'iceland': ISO_TO_LOCAL['IS'],
    'greece': ISO_TO_LOCAL['GR'],
    'hungary': ISO_TO_LOCAL['HU'],
    'israel': ISO_TO_LOCAL['IL'],
    'romania': ISO_TO_LOCAL['RO'],
    'ukraine': ISO_TO_LOCAL['UA'],
  };
