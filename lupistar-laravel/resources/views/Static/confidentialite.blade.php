...
@section('styles')
    <link rel="stylesheet" href="{{ asset('css/style-reglementations.css') }}">
@endsection

@section('content')
    @php($title = 'Politique de confidentialité - lupistar.fr')
    ...
    <main class="main-container">
        ...
        <a href="{{ route('accueil') }}" class="back-button">Retour à l'accueil</a>
